    ...
    <div className="min-h-screen bg-cream font-golos overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 bg-white/80 backdrop-blur-md px-4 py-2.5 rounded-2xl shadow-sm border border-beige-mid">
            <img src="https://cdn.poehali.dev/projects/04112904-6381-486e-bf36-548e9443f9a8/bucket/c7d0db80-8b40-4d44-9ffc-325c54e96733.png" alt="Зелёный Дом" className="h-9 object-contain" />
          </div>
      ...
      <footer className="bg-green-deep border-t border-white/10 px-6 py-8">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <img src="https://cdn.poehali.dev/projects/04112904-6381-486e-bf36-548e9443f9a8/bucket/c7d0db80-8b40-4d44-9ffc-325c54e96733.png" alt="Зелёный Дом" className="h-8 object-contain brightness-0 invert opacity-70" />
          </div>
